...
<html>
    <head>
		...
		<script src="module/user/view/list.js"></script>
		<!-- <script src="module/order/view/list_order.js"></script> -->
	    <script src="module/user/model/validate_user.js"></script>
		<script src="module/user/model/validate_useru.js"></script>
        <script type="text/javascript" src="view/3_lang_js/translate.js"></script>
	...
	<script src="module/search/view/functionsearch.js"></script>

        <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> -->
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0/js/bootstrap.bundle.min.js"></script> -->
	<!-- <script type="text/javascript" src="js/jquery.js"></script> -->
	<!-- <script type="text/javascript" src="view/3_lang_js/en.json"></script>
        <script type="text/javascript" src="view/3_lang_js/va.json"></script> -->
	</head>
    <body>