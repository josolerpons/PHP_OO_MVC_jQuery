<?php
    ...
    // function validate_codprod(){
    //     $cp=$_POST['codprod'];
    //     echo $cp;
    //     $sql = "SELECT codprod FROM productos WHERE codprod='$cp'";
    //     echo "hola";
    ...
    // function validate(){
        ...
        function validate($user){
            ...
            if (DAOUser::select_user2($user)){
                $check=false;
                echo "El codigo de producto ya esta en uso, prueba otro";
            }else {
                $check=true;
                echo "Codigo guardado";
            }
            return $check;
        }
            
        function validate2($user, $id){

            if (DAOUser::select_user3($user, $id)){
                $check=true;
                echo "Codigo guardado";
            }else if (DAOUser::select_user2($user)){
                $check=false;
                echo "El codigo de producto ya esta en uso, prueba otro";
            }
            else {
     ...
     //   $v_codprod=$_POST['codprod'];
        // $r_codprod=validate_codprod();
        
        // if($r_codprod == false){
        //     $error_codpro = " * El codprod introducido no es valido";
        //     $check=false;
